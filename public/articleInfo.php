...
<body class="bg-gray-100">
    <section class="landingPage h-[200px] flex flex-col items-center rounded-b-full ">
        <div
        ...
        <div class=" bg-center gap-12 bg-cover   h-[100vh]  lg:pt-0 mt-24">
            ...
            <div class="mx-auto max-w-screen-sm text-center">
                <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">
                    More informations about Les merveilles de la cuisine française .</h2>
    ...
    <main class="w-[90%] mx-auto px-4 py-8">
        <!-- Article Header -->
        <div class="bg-white rounded-lg shadow-lg overflow-hidden mb-8">
            <img src="./img/rau.webp" alt="Article header" class="w-full h-72 object-cover">
            <div class="p-6">
                <div class="flex justify-between items-start mb-4">
                    <h1 class="text-3xl font-bold text-gray-900">Les merveilles de la cuisine française</h1>
                ...
                <div class="flex flex-wrap gap-2 mb-6">
                    ...
                    <span class="px-3 py-1 bg-green-100 text-green-800 rounded-full text-sm">#france</span>
                    <span class="px-3 py-1 bg-yellow-100 text-yellow-800 rounded-full text-sm">#gastronomie</span>
                </div>
                ...
                <!-- Media Gallery -->
                <div class="mt-8">
                    <h2 class="text-xl font-semibold mb-4">Galerie média</h2>
                    <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
                        <img src="./img/nis.jpg" alt="Gallery 1" class="rounded-lg">
                        <img src="./img/mer.jpg" alt="Gallery 2" class="rounded-lg">
                        <img src="./img/toy.avif" alt="Gallery 3" class="rounded-lg">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-lg p-6">
            <h2 class="text-2xl font-bold mb-6">Commentaires (3)</h2>

            <!-- Add Comment -->
            <div class="mb-8">
                <textarea class="w-full p-4 border rounded-lg mb-2" rows="3"
                    placeholder="Ajouter un commentaire..."></textarea>
                <button class="px-6 py-2 bg-black text-white rounded-lg hover:bg-white hover:text-black border-2 border-black transition">
            ...
            <div class="space-y-6">
                ...
                <div class="border-b pb-6">
                    ...
                    <p class="text-gray-700 ml-14">Excellent article ! Les photos sont magnifiques et donnent vraiment
                        envie de découvrir ces plats.</p>
                </div>
            </div>
