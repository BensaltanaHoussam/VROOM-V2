...
<body class="bg-gray-100">
    ...
    ?>
    <section class="landingPage h-[340px] flex flex-col items-center rounded-b-3xl ">
        <div
    ...
    <section class="bg-[url('../../public/img/bagr.jpg')] bg-center bg-cover    lg:px-24 lg:pt-0">
        ...
        while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
            ...
            echo '<a href="articles.php?id='. htmlspecialchars($row['id_blog']) .'" class="flex items-center gap-2 text-blue-500 hover:text-black">Show more</a>';            echo '</div>';
            echo '</article>';
            echo '</div>';
        }
